//! Regression: a .deb truncated inside a member's content used to extract
//! silently and report full success. extract_entry now errors when the copied
//! bytes fall short of the declared member length.
//!
