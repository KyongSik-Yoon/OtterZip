// SpanZIP.Shell — helper for ShellExecuting the host app with --invoke args.
//
// Sprint 5: each IExplorerCommand::Invoke flattens the IShellItemArray
// into a `;`-separated UTF-8 path list and launches:
//
//   SpanZIP.exe --invoke <verb> --files "<p1>;<p2>;…"
//
// Resolution of `SpanZIP.exe`: in MSIX deployment we use the package
