// SpanZIP.Interop — Native bindings
...
namespace SpanZIP.Interop.Native;

/// <summary>POD mirror of the C <c>SpanzipExtractOptions</c> struct (ffi-api.md §8.1).</summary>
[StructLayout(LayoutKind.Sequential)]
internal unsafe struct SpanzipExtractOptions
{
...
/// <summary>POD mirror of the C <c>SpanzipExtractReport</c>.</summary>
[StructLayout(LayoutKind.Sequential)]
internal struct SpanzipExtractReport
{
...
/// <summary>POD mirror of <c>SpanzipProgressView</c> from ffi-api.md §8.2.</summary>
[StructLayout(LayoutKind.Sequential)]
internal unsafe struct SpanzipProgressView
{
...
/// <summary>POD mirror of <c>SpanzipTestReport</c> (ffi-api.md §10).</summary>
[StructLayout(LayoutKind.Sequential)]
internal struct SpanzipTestReport
{
...
/// <summary>POD mirror of <c>SpanzipCreateOptions</c> from ffi-api.md §9.1.
/// ABI v6 (2026-04-30) appended <see cref="ExcludeSystemMetadata"/>.</summary>
[StructLayout(LayoutKind.Sequential)]
internal unsafe struct SpanzipCreateOptions
{
    public uint Format;
...
/// <summary>POD mirror of <c>SpanzipEntryView</c> from ffi-api.md §6.</summary>
[StructLayout(LayoutKind.Sequential)]
internal unsafe struct SpanzipEntryView
{
...
{
    private const string Lib = "spanzip_ffi";

    // --- Library lifecycle ---

    [LibraryImport(Lib, EntryPoint = "spanzip_init")]
    internal static partial int Init();

    [LibraryImport(Lib, EntryPoint = "spanzip_shutdown")]
    internal static partial void Shutdown();

    [LibraryImport(Lib, EntryPoint = "spanzip_version")]
    internal static partial nint VersionRaw();

    [LibraryImport(Lib, EntryPoint = "spanzip_abi_version")]
    internal static partial uint AbiVersion();

    [LibraryImport(Lib, EntryPoint = "spanzip_last_error_message")]
    internal static partial nint LastErrorMessageRaw();

    [LibraryImport(Lib, EntryPoint = "spanzip_clear_last_error")]
    internal static partial void ClearLastError();

    // --- Format detection ---

    [LibraryImport(Lib, EntryPoint = "spanzip_detect_format")]
    ...
    [LibraryImport(Lib, EntryPoint = "spanzip_archive_open")]
    ...
    [LibraryImport(Lib, EntryPoint = "spanzip_archive_format")]
    internal static partial int ArchiveFormat(IntPtr handle, out uint outFormat);

    // --- Iterator ---

    [LibraryImport(Lib, EntryPoint = "spanzip_iterator_new")]
    internal static partial int IteratorNew(IntPtr handle, out IntPtr outIter);

    [LibraryImport(Lib, EntryPoint = "spanzip_iterator_next")]
    internal static unsafe partial int IteratorNext(IntPtr iter, SpanzipEntryView* outEntry);

    [LibraryImport(Lib, EntryPoint = "spanzip_iterator_free")]
    internal static partial void IteratorFree(IntPtr iter);

    // --- Create / Modify (Sprint 4) ---

    [LibraryImport(Lib, EntryPoint = "spanzip_archive_create")]
    internal static unsafe partial int ArchiveCreate(
        byte* pathUtf8,
        nuint pathLen,
        SpanzipCreateOptions* opts,
        out IntPtr outHandle);

    [LibraryImport(Lib, EntryPoint = "spanzip_archive_add_file")]
    ...
    [LibraryImport(Lib, EntryPoint = "spanzip_archive_add_directory")]
    ...
    [LibraryImport(Lib, EntryPoint = "spanzip_archive_extract_all")]
    internal static unsafe partial int ArchiveExtractAll(
        IntPtr handle,
        SpanzipExtractOptions* opts,
        delegate* unmanaged[Cdecl]<SpanzipProgressView*, IntPtr, int> progressCb,
        IntPtr userData,
        SpanzipExtractReport* outReport);

    // --- Integrity test (Phase 8 G2 / Phase 6+ auto-verify) ---

    [LibraryImport(Lib, EntryPoint = "spanzip_archive_test")]
    internal static unsafe partial int ArchiveTest(
        IntPtr handle,
        delegate* unmanaged[Cdecl]<SpanzipProgressView*, IntPtr, int> progressCb,
        IntPtr userData,
        SpanzipTestReport* outReport);
