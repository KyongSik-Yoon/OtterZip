...
public sealed partial class MainWindow : Window
{
    ...
    private void TrySizeWindow(int width, int height)
    {
        try
        {
            ...
            // SpanZIP is a launcher / config surface, not a workspace —
    ...
    private void ShowOverlayAccept(string subtitle)
    {
        ...
        DropOverlayCard.BorderBrush = (Microsoft.UI.Xaml.Media.Brush)
            Application.Current.Resources["SpanzipBrandBrush"];
        ...
        CancellationToken ct)
    {
        ...
        for (int attempt = 0; attempt < 2; attempt++)
        {
            ...
            catch (SpanzipException ex) when (ex.IsWrongPassword && attempt == 0)
            {
