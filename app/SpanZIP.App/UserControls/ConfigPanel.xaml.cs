...
namespace SpanZIP.App.UserControls;
...
public sealed partial class ConfigPanel : UserControl
{
    ...
    private void OnPasswordChanged(object sender, RoutedEventArgs e)
    {
        ...
        if (hasValue)
        {
            ...
            LockIndicator.Foreground = (Brush)Application.Current.Resources["SpanzipBrandBrush"];
        }
        else
        {
    ...
    private void OnCardPointerEntered(object sender, Microsoft.UI.Xaml.Input.PointerRoutedEventArgs e)
    {
        ...
        {
            b.BorderBrush = (Brush)Application.Current.Resources["SpanzipBrandBrush"];
        }
    }
