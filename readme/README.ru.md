...
- **Выглядит как Windows, потому что это Windows** — собрано на C# и WinUI 3. Настоящий нативный интерфейс, а не веб-страница в окне.
...
Windows 10 (версия 2004) или новее · x64
...
Подробности — в [LICENSE.md](../LICENSE.md).
